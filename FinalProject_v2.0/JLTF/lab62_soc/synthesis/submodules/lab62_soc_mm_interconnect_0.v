...
module lab62_soc_mm_interconnect_0 (
	...
	wire  [105:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> usb_irq_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // usb_irq_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [13:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> usb_irq_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> usb_gpx_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> usb_rst_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> timer_s1_agent:cp_channel
	...
	wire          cmd_mux_013_src_valid;                                                              // cmd_mux_013:src_valid -> spi0_spi_control_port_agent:cp_valid
	wire  [105:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> spi0_spi_control_port_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                              // spi0_spi_control_port_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [13:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> spi0_spi_control_port_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                                      // cmd_mux_013:src_startofpacket -> spi0_spi_control_port_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                        // cmd_mux_013:src_endofpacket -> spi0_spi_control_port_agent:cp_endofpacket
	...
	wire  [105:0] usb_irq_s1_agent_rp_data;                                                           // usb_irq_s1_agent:rp_data -> router_007:sink_data
	...
	wire          spi0_spi_control_port_agent_rp_valid;                                               // spi0_spi_control_port_agent:rp_valid -> router_015:sink_valid
	wire  [105:0] spi0_spi_control_port_agent_rp_data;                                                // spi0_spi_control_port_agent:rp_data -> router_015:sink_data
	wire          spi0_spi_control_port_agent_rp_ready;                                               // router_015:sink_ready -> spi0_spi_control_port_agent:rp_ready
	wire          spi0_spi_control_port_agent_rp_startofpacket;                                       // spi0_spi_control_port_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          spi0_spi_control_port_agent_rp_endofpacket;                                         // spi0_spi_control_port_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          spi0_spi_control_port_agent_rdata_fifo_src_valid;                                   // spi0_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] spi0_spi_control_port_agent_rdata_fifo_src_data;                                    // spi0_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          spi0_spi_control_port_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_013:in_0_ready -> spi0_spi_control_port_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                                  // avalon_st_adapter_013:out_0_valid -> spi0_spi_control_port_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                                   // avalon_st_adapter_013:out_0_data -> spi0_spi_control_port_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                                  // spi0_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                                  // avalon_st_adapter_013:out_0_error -> spi0_spi_control_port_agent:rdata_fifo_sink_error
